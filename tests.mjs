...
console.log('[midweekSlotsOf]');
{
  ...
  eq('tesoros discurso inicial es discursoInicial', slot(tes, tes.parts[0]), ['conductor:discursoInicial']);
  eq('tesoros perlas es perlas', slot(tes, tes.parts[1]), ['conductor:perlas']);
